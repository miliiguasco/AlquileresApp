    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Propiedades", x => x.Titulo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropiedadTitulo = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Imagenes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Imagenes_Propiedades_PropiedadTitulo",
                        column: x => x.PropiedadTitulo,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservas_Propiedades_PropiedadTitulo",
                        column: x => x.PropiedadTitulo,
                        principalTable: "Propiedades",
                        principalColumn: "Titulo",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Imagenes_PropiedadTitulo",
                table: "Imagenes",
                column: "PropiedadTitulo");

            migrationBuilder.CreateIndex(
                name: "IX_Reservas_PropiedadTitulo",
                table: "Reservas",
                column: "PropiedadTitulo");
